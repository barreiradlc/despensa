...
export const ShoppingListContext = createContext<ShoppingListContextData>({} as ShoppingListContextData)
...
export const ShoppingListProvider: React.FC = ({ children }) => {
    ...
    return (
        <ShoppingListContext.Provider value={{ validItems, items, setItemsList, setItemsQuantity, populateItemsList, pantryUuid }}>
            {children}
